...
class SearchAdmin extends LeftAndMain implements PermissionProvider
{
    ...
    public function getEditForm($id = null, $fields = null): Form
    {
        ...
        if (!$indexedDocumentsList->count() && !$indexedDocumentsList->dataClass()) {
            ...
            $indexedDcoumentsWarningField = LiteralField::create(
                'IndexedDocumentsWarning',
                '<div class="alert alert-warning">
                    <strong>No indexes found.</strong> Indexes must be configured before indexed documents can be listed or reindexed
                </div>'
            );

            $fields[] = $indexedDcoumentsWarningField;
        } else {
